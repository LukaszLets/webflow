document.addEventListener('DOMContentLoaded', function () {
	...
	async function wykonajZadanieIGoPrzekieruj() {
		...
		const url = `https://app.easycart.pl/api/dynamic-price/prod_OacwvSnmaoGtqa/${brutto2.toFixed(2)}?param1=${tekstElement2.textContent}&param2=${tekstElement3.textContent.replace(" ", "").replace("/","_")}&param3=${tekstElement4.textContent.replace(" ", "").replace("/","_")}`;

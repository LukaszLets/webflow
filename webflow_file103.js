document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('dalej1').addEventListener('click', function() {
        // Dla większości przeglądarek oraz IE9+
    ...
    function checkSelection() {
        ...
        for (let i = 1; i <= 4; i++) {
            ...
            binaryRepresentation += btn.classList.contains('selected') ? '1' : '0';
        }
        
        return mapping[binaryRepresentation];
    }
    
    for (let i = 1; i <= 4; i++) {
        const btn = document.getElementById(`btn${i}`);
        btn.addEventListener('click', function() {
            this.classList.toggle('selected'); // Dodaj/usuń klasę "selected"
        });
    }
    ...
    document.getElementById('dalej3').addEventListener('click', function (event) {
        ...
        const selectedValue = checkSelection();
        console.log("Wybrana wartość:", selectedValue);
        // Teraz możesz użyć tej wartości do przekierowania użytkownika w odpowiednie miejsce
    });
    ...
    document.getElementById('dalej3').addEventListener('click', function (event) {
      ...
      if (wybrano == '1') {
        window.open('https://app.easycart.pl/checkout/98638600/paczka-automatyzacji-do-samodzielnego-wdrozenia?plan=price_1O80ZnAiRAmm1dcU7ViSsYJO', '_blank');
    } else if (wybrano == "2") {
        window.open('https://strona2.pl', '_blank');
    } else if (wybrano == "3") {
        window.open('https://strona3.pl', '_blank');
    } 
    else if (wybrano == "4") {
        window.open('https://strona3.pl', '_blank');
    } 

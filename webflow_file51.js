document.addEventListener('DOMContentLoaded', function () {
    ...
    function setTextAndStyles4(value, clickedButton, clickedContainer, text) {
      ...
      if (value === '9') {
        textElement3.textContent += '99';
        konsultacja.style.display = 'block';
      } else if (value === '10') {
        textElement3.textContent += '79';
        ponowne.style.display = 'block';
      } else if (value === '11') {
        textElement3.textContent += '99';
        automatyczny.style.display = 'block';

      } else if (value === '12') {
        textElement3.textContent += '99';
        zbieranie.style.display = 'block';

      }
      
        clickedButton.style.backgroundColor = '#00FF9F !important';
        clickedContainer.style.border = '1px solid #00FF9F !important';
        text.style.color = '#ACB0B9 !important';
    }
  
    function resetButton4() {
      button4.style.backgroundColor = '#1E2024';
      savetext4.style.color = '#FFFFFF !important';
    ...
    function resetButton5() {
      ...
      savetext5.style.color = '#FFFFFF !important';

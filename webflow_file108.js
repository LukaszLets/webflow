document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('dalej3').addEventListener('click', function (event) {
     event.preventDefault();
      ...
      const param1 = document.getElementById('dalejvalue3').value;
      const url = `https://app.easycart.pl/checkout/98638600/paczka-automatyzacji-do-samodzielnego-wdrozenia?plan=price_1O80ZnAiRAmm1dcU7ViSsYJO&param1=${encodeURIComponent(param1)}`;

document.addEventListener('DOMContentLoaded', function () {
    ...
    var errorContainer1 = document.getElementById('dalej_error1');
    var errorContainer2 = document.getElementById('dalej_error2');
    var errorContainer3 = document.getElementById('dalej_error3');
    ...
    function setTextAndStyles2(value, clickedButton, clickedContainer, text) {
      ...
      let allButtons = [button4, button5];
      allButtons.forEach((btn) => {
        if (btn !== clickedButton) {
          btn.style.backgroundColor = '#1E2024';
          btn.style.border = 'none !important';
      ...
      let allContainers = [container4, container5];
      allContainers.forEach((ctn) => {
        if (ctn !== clickedContainer) {
            ctn.style.border = '0px solid #00FF9F';
        }
      });
      let allTxts = [savetext4, savetext5];
      allTxts.forEach((txts) => {
        if (txts !== text) {
            txts.style.color = '#ffffff';
        }
    ...
    function setTextAndStyles3(value, clickedButton, clickedContainer, text) {
      ...
      let allTxts = [savetext6, savetext7, savetext8];
      allTxts.forEach((txts) => {
        if (txts !== text) {
            txts.style.color = '#ffffff';
        }
    ...
    function setTextAndStyles4(value, clickedButton, clickedContainer, text) {
      ...
      let allTxts = [savetext9, savetext10, savetext11, savetext12];
      allTxts.forEach((txts) => {
        if (txts !== text) {
            txts.style.color = '#ffffff';
        }

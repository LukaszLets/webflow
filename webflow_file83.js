document.addEventListener('DOMContentLoaded', function () {
    ...
    let cena = 990;
    document.getElementById('cena').innerText = cena + 'zł';

    let vat = (cena * 23) / 100;
    document.getElementById('vat').innerText = vat.toFixed(2) + 'zł';

    let razem = cena;
    document.getElementById('razem').innerText = razem.toFixed(2) + 'zł';
    ...
    function sendToWebhook() {
        ...
        var webhookUrl = 'https://hook.eu1.make.com/y7ngx3rfr2s8255xcy9ax59vwo311t9l';
        ...
        var data = {
            ...
            key2: dalejValue2,
            key3: dalejValue3,
            key4: 'dodać wartosci z ostatniego okna'
        };

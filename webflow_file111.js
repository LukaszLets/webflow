document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('dalej3').addEventListener('click', function (event) {
     event.preventDefault();
      ...
      const url = `https://sandbox.easycart.pl/checkout/98638600/paczka-automatyzacji-do-samodzielnego-wdrozenia?plan=price_1O80ZnAiRAmm1dcU7ViSsYJO&param1=${encodeURIComponent(dalejValue1)}&param2=${encodeURIComponent(dalejValue2)}&param3=${encodeURIComponent(dalejValue3)}`;

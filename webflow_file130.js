document.addEventListener('DOMContentLoaded', function () {
  ...
  let brutto = cena + vat;
  document.getElementById('brutto').innerText =
    brutto.toFixed(2) + ' zł brutto';

  let brutto2 = cena + vat;
  document.getElementById('brutto2').innerText =
    '(' + brutto2.toFixed(2) + ' z VAT)';
  ...
  document
    .getElementById('dalej3')
    .addEventListener('click', wykonajZadanieIGoPrzekieruj);
  ...
  function setTextAndStyles4(value, clickedButton, clickedContainer, text) {
    ...
    if (value === '9' && !contains1) {
      ...
      document.getElementById('cena').innerText = cena.toFixed(2) + ' zł';
      document.getElementById('vat').innerText = vat.toFixed(2) + ' zł';
      document.getElementById('razem').innerText =
        razem.toFixed(2) + ' zł Netto';
      document.getElementById('brutto').innerText =
        brutto.toFixed(2) + ' zł Brutto';
      document.getElementById('brutto2').innerText =
        '(' + brutto2.toFixed(2) + ' z VAT)';

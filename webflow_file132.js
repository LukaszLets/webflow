document.addEventListener('DOMContentLoaded', function () {
	...
	async function wykonajZadanieIGoPrzekieruj() {
		...
		const url = `https://app.easycart.pl/api/dynamic-price/prod_OacwvSnmaoGtqa/${brutto2.toFixed(2)}`;
		...
		if (response.data) {
			window.open(response.data + `&param1=${tekstElement2.textContent}&param2=${tekstElement3.textContent}&param3=${tekstElement4.textContent}`, '_blank');
		}
	}
